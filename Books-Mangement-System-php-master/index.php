...
<body>
<h1 style="text-align: center"><strong>登陆界面</strong></h1>
<div style="padding: 180px 550px 10px;text-align: center">
    <form  action="login_check.php" method="POST" class="bs-example bs-example-form" role="form">
        <div id="login">
            <div class="input-group"><span class="input-group-addon">用户名</span><input  name="account" type="text" placeholder="请输入读者证号或管理员账号" class="form-control"></div><br><br>
